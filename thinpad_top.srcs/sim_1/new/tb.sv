...
module tb;
  ...
  parameter BASE_RAM_INIT_FILE = "D:\\Acquah\\ucore\\rbl.img"; // BaseRAM 初始化文件，请修改为实际的绝对路�?
  parameter EXT_RAM_INIT_FILE = "D:\\Acquah\\ucore\\ucore.img";  // ExtRAM 初始化文件，请修改为实际的绝对路�?
...
//    uart.pc_send_byte(8'd00);
  ...
  integer save_file;
initial begin
    save_file = $fopen("D:\\temp\\pc.txt");    //�����������ļ������Ҳ������ļ�������Զ��������ļ���
...
always @(posedge dut.clk_65M) begin
    if (~dut.stall)
        $fdisplay(save_file,"%x",dut.pc);    //��ʹ���ź�Ϊ��ʱ��ÿ��ʱ�ӵ������ص���ʱ������д�뵽��������.txt�ļ���
end
